...
% \begin{figure}[htp!]
%  \centering
%  \includegraphics[width=\textwidth]{./bar_test_setup}
%  \caption[Scintillator bar quality test bench]{Scintillator bar quality test bench. From left to right: LED box, bar connectors, bars attached to the LED box, camera
%  taking photos of bar connectors.}
%  \label{fig:bar_test_setup}
% \end{figure}
...
% as shown in Figure \ref{fig:bar_test_setup}.
...
% (see Figure~\ref{fig:plane_test_setup}).
...
% \begin{figure}[htb]
%  \centering
%  \includegraphics[width=0.9\textwidth]{./plane_test_setup}
%  \caption[Plane quality tests]{Plane quality tests. {\bf Left:} LED tube with blue light to be attached to single-anode PMT connector. {\bf Center:} multi-anode PMT
%  connector inside shielding. {\bf Left:} PMT mask.}
%  \label{fig:plane_test_setup}
% \end{figure}
